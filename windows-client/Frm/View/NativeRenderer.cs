...
namespace LanDataTransmitter.Frm.View {
    ...
    public class NativeRenderer : ToolStripSystemRenderer {
        ...
        internal static class NativeMethods {
            ...
            public extern static int GetThemeMargins(IntPtr hTheme, IntPtr hdc, int iPartId, int iStateId, int iPropId, IntPtr rect, out NativeRenderer.NativeMethods.MARGINS pMargins);
